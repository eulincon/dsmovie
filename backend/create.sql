create table tb_movie (id int8 generated by default as identity, count int4 not null, image varchar(255), score float8 not null, title varchar(255), primary key (id));
